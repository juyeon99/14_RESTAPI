...
public class HateoasTestController {
    /*
    * Hateoas
    * 하나의 api를 동작시켰을 때 그 전 상황이나 그 후 상황에 대한 링크를 제공함으로써
    * 클라이언트가 리소스(자원)에 대한 이해를 더욱 충분히 할 수 있도록 링크를 제공하는 것
    *
    * (Hateoas까지 구현했을 때, Restful의 성숙도 3단계 API(최종단계)라고 한다.)
    * */
    ...
    public ResponseEntity<ResponseMessage> findAllUsers() {
        ...
        // EntityModel: Hateoas를 제공하는 클래스
        //              REST API를 만들 때 해당 자원과 관련된 링크를 포함할 수 있게 해준다.
